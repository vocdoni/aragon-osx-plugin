...
import {Operation, Permission} from '../../../../utils/types';
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  console.log(
    `\nManagingDao is no longer owned by the (Deployer: ${deployer.address}),` +
      ` and all future actions of the (managingDAO: ${managingDAOAddress}) will be handled by the newly installed (VocdoniVoting plugin).`
  );
};
export default func;
